/**
 * SMART CARD GENERICA - CONECTA ALT PRO
 * MOTOR ROBUSTO CORREGIDO TOTAL - ACTUALIZACIÓN DE ENLACES
 */

const LORENA_DATA = { titulo: "INNOVACION EDUCATIVA" };
...
const CONFIG = { 
    ...
    mapa: "https://demo-altpro.com/", 
    allowedExt: ['.jpg', '.jpeg', '.png', '.webp', '.JPG', '.JPEG'] 
};

// RELACIÓN DE LINKS ACTUALIZADA: JUEGOS INTERACTIVOS (GENÉRICOS)
const JUEGOS_DATA = [
    { nombre: "GATO", link: "http://gato-tri-gen.surge.sh/", img: "GATO" },
    { nombre: "MEMORAMA", link: "https://memorama-ingles-gen.surge.sh/", img: "MEMORAMA" },
    { nombre: "ASOCIACIÓN", link: "http://asocia-historia-gen.surge.sh/", img: "ASOCIA" },
    { nombre: "ROMPECABEZAS", link: "http://rompecabezas-gen.surge.sh/", img: "ROMPECABEZAS" }
];
...
async function shareExperienceRobust() { 
    playClick(); 
    try { await navigator.share({title: 'CONECTA ALT PRO | SMART CARD', url: window.location.href}); } 
    catch(e) { 
